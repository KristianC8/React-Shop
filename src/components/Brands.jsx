...
export const Brands = () => {
  return (
    <section className='flex flex-col gap-8 items-center px-10 sm:px-14 xl:px-28 2xl:px-56 pb-8'>
      <div className='text-center'>
        ...
        <p className='text-base sm:text-lg lg:text-xl 2xl:text-2xl text-secondaryLight dark:text-secondaryDark'>Products from the best brands, gathered for you in one place.</p>
      </div>
